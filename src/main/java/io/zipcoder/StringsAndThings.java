    ...
    public Boolean containsEqualNumberOfIsAndNot(String input) {
        ...
        public Boolean gIsHappy (String input){
            ...
            for(int i = 1; i < input.length(); i ++){
                ...
                } else if(input.charAt(i) == 'g' && input.charAt(i-1) != 'g' || input.charAt(i) == 'g' && input.charAt(i+1) != 'g'){
                    return false;
                }
         ...
         *            countTriple("xxxabyyyycd") // Should return 2
        ...
        for(int i = 0;i < input.length();i ++){
            if(input.charAt(i) == i  && input.charAt(i-1) == i && input.charAt(i+1)==i){
             counter ++;
            }
